...
export const routesMeta = [
  {
    ...
    description:
      "全球反禁藥教學案例搜尋、WADA 禁用清單、互動測驗、藥檢流程與 TUE 申請指南，協助選手、教練與醫療人員了解反禁藥規範。",
  },
  {
    path: "/cases",
    title: "案例搜尋 | 乾淨運動從你我開始",
    description:
      "依運動項目、國籍、年份、禁藥類別與處罰結果，搜尋全球反禁藥教學案例，每筆標示查核層級與官方資料來源。",
  },
  {
    path: "/statistics",
    title: "數據統計 | 乾淨運動從你我開始",
    description:
      "以互動圖表呈現運動禁藥案例的運動項目、禁藥類別與處罰程度分布，以及收錄案例的年份分布。",
  },
  {
    path: "/education",
