            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mb-2">
                  PRP、高壓氧、ILIB、感冒藥、Ozempic... 逐題揭曉答案
                </p>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-4">
        <button
          onClick={reset}
          className="flex items-center gap-1 text-gray-500 text-sm hover:text-emerald-600 transition-colors"
        >
        ...
        <span className="text-sm text-gray-500 font-medium">
          ...
          {mode === "quiz" && (
            <span className="ml-2 text-emerald-600">得分 {score}</span>
          )}
        </span>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100 mb-5">
        ...
        <div className="space-y-3">
          {q.options.map((opt, idx) => {
            let style =
              "bg-gray-50 border-gray-200 text-gray-900 hover:border-emerald-300 hover:bg-emerald-50";
            let icon = null;
            if (revealed) {
      ...
      {revealed && (
        <div
          className={`rounded-2xl p-5 md:p-6 mb-5 border ${
