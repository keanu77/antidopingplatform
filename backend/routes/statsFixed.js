...
const overviewHandler = async (req, res) => {
  try {
    ...
    const [totalCases, uniqueSports, uniqueCountries, uniqueSubstances] =
      await Promise.all([
                ...
                branches: [
                  {
                    case: {
                      $regexMatch: {
                        input: {
                          $toLower: {
                            $ifNull: ["$punishment.banDuration", ""],
                          },
                        },
                        regex:
                          /無處罰|合法tue|tue證明|無禁賽|無正式禁賽|無（成功|當時合法/,
                      },
                    },
                    then: "無處罰 (TUE/合法)",
                  },
                  ...
                  },
                  {
                    case: {
                      $regexMatch: {
                        ...
                        regex: /14個月|15個月|18個月|2年|22個月|21個月/,
                      },
                    },
                    then: "1-2年",
                  },
                  ...
                  },
                  {
                    case: {
                      $regexMatch: {
                        ...
                        regex: /4年|4年3個月|8年|4年集體禁賽|6年|5年/,
                      },
                    },
                    then: "4年以上",
                  },
                  ...
                  },
                  {
                    case: {
                      $regexMatch: {
                        ...
                        regex:
                          /追溯性道德譴責|學術聲譽受損|車隊解散|終身禁入體育界|聲譽受損/,
                      },
                    },
                    then: "聲譽受損",
                  },
                  {
                    case: {
                      $regexMatch: {
                        ...
                        regex: /無確鑿證據|暫時禁賽|暫時禁賽後撤銷|無證據確鑿/,
                      },
                    },
                    then: "暫時禁賽：無確鑿證據",
                  },
                  {
                    case: {
                      $regexMatch: {
                        ...
                        regex:
                          /場禁賽|場比賽|球季|賽季|80場|162場|211場|50場|65場|25場|20場|10場/,
                      },
                    },
                    then: "特定比賽場次",
                  },
...
router.get("/punishment-stats", async (req, res) => {
  try {
    ...
    const [medalStripped, resultsCancelled] = await Promise.all([
      db
        .collection("cases")
        .countDocuments({ "punishment.medalStripped": true }),
      db
        .collection("cases")
        .countDocuments({ "punishment.resultsCancelled": true }),
    ]);
