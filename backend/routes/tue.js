  ...
  basicInfo: [
    {
      ...
      title: "什麼是治療用途豁免(TUE)？",
      content:
        "TUE是Therapeutic Use Exemption的縮寫，即治療用途豁免。當運動員因健康需要必須使用WADA禁用清單上的物質或方法時，可以通過TUE申請程序獲得使用許可。",
      points: [
        "僅適用於醫療必需的治療",
        "必須符合嚴格的申請條件",
        "需要經過專業醫療委員會審查",
  ...
  applicationGuide: {
    steps: [
      ...
      },
      {
        ...
        documents: ["TUE申請表", "醫師證明書", "藥物使用說明"],
      },
      {
        title: "醫師簽名確認",
        description: "由具資格的醫師審核並簽名確認申請內容",
        documents: ["醫師執照副本", "醫師簽名確認書"],
      },
      {
        title: "提交申請",
        description: "將完整申請文件提交至相關反禁藥組織",
        documents: ["所有文件的正本或認證副本", "申請費用繳費證明（如適用）"],
      },
      {
        title: "等待審查",
        description: "專業醫療委員會審查申請，可能要求補充資料",
        documents: ["補充醫療資料（如要求）", "回應審查委員會提問"],
      },
      {
        title: "獲得決定",
        description: "收到TUE決定通知，如獲批准則可開始使用",
        documents: ["TUE證書（如獲批准）", "駁回理由說明（如被拒絕）"],
      },
    ],
    documents: [
      {
  ...
  diseaseGuides: [
    {
      ...
      name: "氣喘 (Asthma)",
      description:
        "氣喘是最常見需要申請TUE的疾病之一。運動引起的支氣管收縮需要使用Beta-2激動劑治療。",
      commonMedications: [
        "Salbutamol (吸入劑)",
        "Formoterol",
        "Salmeterol",
    ...
    },
    {
      ...
      alternatives:
        "第一型糖尿病沒有替代治療方法，胰島素是生命必需品。第二型糖尿病可考慮飲食控制、運動療法和其他口服藥物。",
    },
    {
      id: 3,
      name: "注意力缺陷過動症 (ADHD)",
      ...
      alternatives:
        "行為治療、認知行為療法、環境調整、時間管理技巧等非藥物方法。Atomoxetine等非興奮劑類藥物可能是選擇。",
    },
    {
      id: 4,
      name: "心血管疾病",
      ...
      alternatives:
        "ACE抑制劑、鈣離子阻斷劑等非禁用藥物，生活方式調整，心臟復健計劃。",
    },
    {
      id: 5,
      name: "焦慮症",
      description:
        "嚴重焦慮症患者可能需要使用鎮靜劑，但在運動中使用需要謹慎評估。",
      commonMedications: [
        "Benzodiazepines",
        "Beta阻斷劑 (off-label)",
        "SSRI抗憂鬱劑",
    ...
    },
    {
      ...
      alternatives:
        "非類固醇抗發炎藥物(NSAIDs)、物理治療、針灸、神經阻斷術、心理治療等綜合疼痛管理方法。",
    },
  ],
  tools: {
    checklist: [
